...
class PlayState extends FlxState
{
	...
	override public function create():Void
	{
		...
		#if !flash
		FlxG.log.error("FlxEmojiParticle is only supported on Flash target for now.");
		#else
		...
		_fx = new FlxSprite();
		_fx.loadGraphic("assets/images/20x20/" + randEmoji + ".png");
